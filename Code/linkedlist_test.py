...
class LinkedListTest(unittest.TestCase):
    ...
    def test_find(self):
        ll = LinkedList(['A', 'B', 'C'])
        assert ll._find(lambda item: item == 'B').data == 'B'  # Match equality
        # assert ll.find('B') == 'B'  # Match equality
        assert ll._find(lambda item: item < 'B').data == 'A'  # Match less than
        assert ll._find(lambda item: item > 'B').data == 'C'  # Match greater than
        assert ll._find(lambda item: item == 'X') is None  # No matching item
